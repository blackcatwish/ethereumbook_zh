...
(topsun:1.而是把收款人地址加到了代币合约中 
       -->而是把收款人地址加到了包含于代币合约的映射中
        2.即便是一个支持 ERC20 代币的钱包也不会变得能够知道代币余额 
       -->即便是一个支持 ERC20 代币的钱包也不能识别代币余额）
...
（topsun: 1.你只有当你用区块链浏览器或者钱包去监听这些合约里你的地址时才会看到这些余额。 
